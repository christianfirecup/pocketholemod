	...
	public static void executeProcedure(Map<String, Object> dependencies) {
		if (dependencies.get("x") == null) {
			if (!dependencies.containsKey("x"))
				PocketDimentionsMod.LOGGER.warn("Failed to load dependency x for procedure PocketPlayerEntersDimension!");
			return;
		}
		if (dependencies.get("y") == null) {
			if (!dependencies.containsKey("y"))
				PocketDimentionsMod.LOGGER.warn("Failed to load dependency y for procedure PocketPlayerEntersDimension!");
			return;
		}
		if (dependencies.get("z") == null) {
			if (!dependencies.containsKey("z"))
				PocketDimentionsMod.LOGGER.warn("Failed to load dependency z for procedure PocketPlayerEntersDimension!");
			return;
		}
