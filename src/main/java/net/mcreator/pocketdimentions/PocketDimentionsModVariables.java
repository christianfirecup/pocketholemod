package net.mcreator.pocketdimentions;
...
public class PocketDimentionsModVariables {
	...
	public void onPlayerLoggedIn(PlayerEvent.PlayerLoggedInEvent event) {
		if (!event.getPlayer().world.isRemote()) {
			...
			if (mapdata != null)
				PocketDimentionsMod.PACKET_HANDLER.send(PacketDistributor.PLAYER.with(() -> (ServerPlayerEntity) event.getPlayer()),
	...
	public static class WorldVariables extends WorldSavedData {
		public static final String DATA_NAME = "pocket_dimentions_worldvars";
		...
		public void syncData(IWorld world) {
			...
			if (world instanceof World && !world.isRemote())
				PocketDimentionsMod.PACKET_HANDLER.send(PacketDistributor.DIMENSION.with(((World) world)::getDimensionKey),
	...
	public static class MapVariables extends WorldSavedData {
		public static final String DATA_NAME = "pocket_dimentions_mapvars";
		...
		public void syncData(IWorld world) {
			this.markDirty();
			if (world instanceof World && !world.isRemote())
				PocketDimentionsMod.PACKET_HANDLER.send(PacketDistributor.ALL.noArg(), new WorldSavedDataSyncMessage(0, this));
		}
