...
package net.mcreator.pocketdimentions.world.dimension;
...
public class PocketDimension extends PocketDimentionsModElements.ModElement {
	...
	public void init(FMLCommonSetupEvent event) {
		...
		replaceableBlocks.add(ForgeRegistries.BIOMES.getValue(new ResourceLocation("the_void")).getGenerationSettings().getSurfaceBuilder().get()
	...
	public void clientLoad(FMLClientSetupEvent event) {
		...
		DeferredWorkQueue.runLater(() -> {
			try {
				...
				effectsRegistry.put(new ResourceLocation("pocket_dimentions:pocket"), customEffect);
			} catch (Exception e) {
				e.printStackTrace();
			}
		});
	...
	public void onPlayerChangedDimensionEvent(PlayerEvent.PlayerChangedDimensionEvent event) {
		...
		if (event.getTo() == RegistryKey.getOrCreateKey(Registry.WORLD_KEY, new ResourceLocation("pocket_dimentions:pocket"))) {
			...
			PocketPlayerEntersDimensionProcedure
