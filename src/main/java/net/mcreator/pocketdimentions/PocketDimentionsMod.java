 ...
 *
 *    Keep the PocketDimentionsModElements object in this class and all calls to this object
...
@Mod("pocket_dimentions")
public class PocketDimentionsMod {
	public static final Logger LOGGER = LogManager.getLogger(PocketDimentionsMod.class);
	...
	public PocketDimentionsMod() {
		...
		MinecraftForge.EVENT_BUS.register(new PocketDimentionsModFMLBusEvents(this));
	}
